...
import { Monitor, Smartphone, Tablet, Globe, LogOut, AlertCircle } from 'lucide-react'
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    <div className="p-2 bg-gray-100 rounded-lg">
                      <DeviceIcon className="h-5 w-5 text-gray-700" />
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Son aktif: {formatDate(session.expires)}
                      </p>
                      {session.ip && (
